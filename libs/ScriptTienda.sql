...
CREATE TABLE venta (id_venta INT, id_cliente INT, id_producto INT, fecha_venta DATE, primary key (id_venta),FOREIGN KEY (id_cliente) REFERENCES cliente(dni), FOREIGN KEY (id_producto) REFERENCES producto(id_producto));
